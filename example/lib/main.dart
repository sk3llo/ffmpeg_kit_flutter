...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'FFmpeg Kit with Hardware Acceleration',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepPurple),
      ),
      home: const MyHomePage(title: 'FFmpeg Kit with Hardware Acceleration'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  String logString = 'FFmpeg Kit with Hardware Acceleration Demo\n\n';
