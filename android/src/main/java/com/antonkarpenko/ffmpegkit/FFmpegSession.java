 ...
 * <p>An FFmpeg session.
 */
public class FFmpegSession extends com.antonkarpenko.ffmpegkit.AbstractSession implements com.antonkarpenko.ffmpegkit.Session {

    /**
     * Session specific statistics callback.
     */
    private final com.antonkarpenko.ffmpegkit.StatisticsCallback statisticsCallback;
     ...
     */
    private final List<com.antonkarpenko.ffmpegkit.Statistics> statistics;
    ...
    public static FFmpegSession create(final String[] arguments) {
        return new FFmpegSession(arguments, null, null, null, com.antonkarpenko.ffmpegkit.FFmpegKitConfig.getLogRedirectionStrategy());
    }
     ...
     * @return created session
     */
    public static FFmpegSession create(final String[] arguments, final com.antonkarpenko.ffmpegkit.FFmpegSessionCompleteCallback completeCallback) {
        return new FFmpegSession(arguments, completeCallback, null, null, com.antonkarpenko.ffmpegkit.FFmpegKitConfig.getLogRedirectionStrategy());
    }
    ...
    public static FFmpegSession create(final String[] arguments,
        ...
        return new FFmpegSession(arguments, completeCallback, logCallback, statisticsCallback, com.antonkarpenko.ffmpegkit.FFmpegKitConfig.getLogRedirectionStrategy());
    }
     ...
     */
    public com.antonkarpenko.ffmpegkit.StatisticsCallback getStatisticsCallback() {
     ...
     */
    public com.antonkarpenko.ffmpegkit.FFmpegSessionCompleteCallback getCompleteCallback() {
     ...
     */
    public List<com.antonkarpenko.ffmpegkit.Statistics> getAllStatistics(final int waitTimeout) {
        waitForAsynchronousMessagesInTransmit(waitTimeout);

        if (thereAreAsynchronousMessagesInTransmit()) {
            android.util.Log.i(com.antonkarpenko.ffmpegkit.FFmpegKitConfig.TAG, String.format("getAllStatistics was called to return all statistics but there are still statistics being transmitted for session id %d.", sessionId));
        }
     ...
     * @return list of statistics entries generated for this session
     */
    public List<com.antonkarpenko.ffmpegkit.Statistics> getAllStatistics() {
     ...
     */
    public List<com.antonkarpenko.ffmpegkit.Statistics> getStatistics() {
     ...
     * received
     */
    public com.antonkarpenko.ffmpegkit.Statistics getLastReceivedStatistics() {
        synchronized (statisticsLock) {
     ...
     */
    public void addStatistics(final com.antonkarpenko.ffmpegkit.Statistics statistics) {
        synchronized (statisticsLock) {
