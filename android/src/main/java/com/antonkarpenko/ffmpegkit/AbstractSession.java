 ...
 */
public abstract class AbstractSession implements com.antonkarpenko.ffmpegkit.Session {
     ...
     */
    protected final com.antonkarpenko.ffmpegkit.LogCallback logCallback;
     ...
     */
    protected final List<com.antonkarpenko.ffmpegkit.Log> logs;
     ...
     */
    protected com.antonkarpenko.ffmpegkit.SessionState state;

    /**
     * Return code for the completed sessions.
     */
    protected com.antonkarpenko.ffmpegkit.ReturnCode returnCode;
...
//    protected String failStackTrace;
     ...
     */
    protected final com.antonkarpenko.ffmpegkit.LogRedirectionStrategy logRedirectionStrategy;
    ...
    protected AbstractSession(final String[] arguments,
        ...
        this.future = null;
        this.state = com.antonkarpenko.ffmpegkit.SessionState.CREATED;
        this.returnCode = null;
//        this.failStackTrace = null;
        this.logRedirectionStrategy = logRedirectionStrategy;

        com.antonkarpenko.ffmpegkit.FFmpegKitConfig.addSession(this);
    }

    @Override
    public com.antonkarpenko.ffmpegkit.LogCallback getLogCallback() {
        return logCallback;
    }
    ...
    public String getCommand() {
        return com.antonkarpenko.ffmpegkit.FFmpegKitConfig.argumentsToString(arguments);
    }

    @Override
    public List<com.antonkarpenko.ffmpegkit.Log> getAllLogs(final int waitTimeout) {
        waitForAsynchronousMessagesInTransmit(waitTimeout);

        if (thereAreAsynchronousMessagesInTransmit()) {
            android.util.Log.i(com.antonkarpenko.ffmpegkit.FFmpegKitConfig.TAG, String.format("getAllLogs was called to return all logs but there are still logs being transmitted for session id %d.", sessionId));
        }
     ...
     */
    @Override
    public List<com.antonkarpenko.ffmpegkit.Log> getAllLogs() {
        return getAllLogs(DEFAULT_TIMEOUT_FOR_ASYNCHRONOUS_MESSAGES_IN_TRANSMIT);
    }

    @Override
    public List<com.antonkarpenko.ffmpegkit.Log> getLogs() {
    ...
    public String getAllLogsAsString(final int waitTimeout) {
        ...
        if (thereAreAsynchronousMessagesInTransmit()) {
            android.util.Log.i(com.antonkarpenko.ffmpegkit.FFmpegKitConfig.TAG, String.format("getAllLogsAsString was called to return all logs but there are still logs being transmitted for session id %d.", sessionId));
        }
    ...
    @Override
    public com.antonkarpenko.ffmpegkit.SessionState getState() {
        return state;
    }

    @Override
    public com.antonkarpenko.ffmpegkit.ReturnCode getReturnCode() {
        return returnCode;
    }
...
//    }
    ...
    @Override
    public com.antonkarpenko.ffmpegkit.LogRedirectionStrategy getLogRedirectionStrategy() {
        return logRedirectionStrategy;
    }

    @Override
    public boolean thereAreAsynchronousMessagesInTransmit() {
        return (com.antonkarpenko.ffmpegkit.FFmpegKitConfig.messagesInTransmit(sessionId) != 0);
    }

    @Override
    public void addLog(final com.antonkarpenko.ffmpegkit.Log log) {
        synchronized (logsLock) {
            this.logs.add(log);
        }
    }
    ...
    @Override
    public void cancel() {
        if (state == com.antonkarpenko.ffmpegkit.SessionState.RUNNING) {
            com.antonkarpenko.ffmpegkit.FFmpegKit.cancel(sessionId);
        }
    }
     ...
     */
    void startRunning() {
        this.state = com.antonkarpenko.ffmpegkit.SessionState.RUNNING;
     ...
     */
    void complete(final com.antonkarpenko.ffmpegkit.ReturnCode returnCode) {
        this.returnCode = returnCode;
        this.state = com.antonkarpenko.ffmpegkit.SessionState.COMPLETED;
...
//        this.failStackTrace = Exceptions.getStackTraceString(exception);
        this.state = com.antonkarpenko.ffmpegkit.SessionState.FAILED;
        this.endTime = new Date();
    }
