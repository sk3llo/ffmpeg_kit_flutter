...
# 🎬 FFmpegKit for Flutter — HTTPS-GPL
...
<p align="center">
  <a href="https://pub.dev/packages/ffmpeg_kit_flutter_new_https_gpl"><img src="https://img.shields.io/badge/pub-2.5.3-blue?logo=dart" alt="pub version"></a>
...
```yaml
dependencies:
  ffmpeg_kit_flutter_new_https_gpl: ^2.6.0
```
...
| [`_https_gpl`](https://pub.dev/packages/ffmpeg_kit_flutter_new_https_gpl) **(this one)** | HTTPS **+ GPL** codecs |
