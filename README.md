...
<p align="center">
  <a href="https://pub.dev/packages/ffmpeg_kit_flutter_new_https"><img src="https://img.shields.io/badge/pub-2.4.2-blue?logo=dart" alt="pub version"></a>
...
```yaml
dependencies:
  ffmpeg_kit_flutter_new_https: ^2.4.2
```
...
| [`_https`](https://pub.dev/packages/ffmpeg_kit_flutter_new_https) **(this one)** | Adds TLS (`gnutls`) for `https://` inputs |
