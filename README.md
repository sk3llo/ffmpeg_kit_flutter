...
<p align="center">
  <a href="https://pub.dev/packages/ffmpeg_kit_flutter_new_min"><img src="https://img.shields.io/badge/pub-3.5.4-blue?logo=dart" alt="pub version"></a>
...
```yaml
dependencies:
  ffmpeg_kit_flutter_new_min: ^3.5.0
```
...
| Package | Best for |
|---|---|
| [`_min`](https://pub.dev/packages/ffmpeg_kit_flutter_new_min) **(this one)** | Smallest build — core FFmpeg only |
