...
<p align="center">
  <a href="https://pub.dev/packages/ffmpeg_kit_flutter_new_video"><img src="https://img.shields.io/badge/pub-2.3.2-blue?logo=dart" alt="pub version"></a>
...
```yaml
dependencies:
  ffmpeg_kit_flutter_new_video: ^2.3.2
```
