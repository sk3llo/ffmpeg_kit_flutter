...
<p align="center">
  <a href="https://pub.dev/packages/ffmpeg_kit_flutter_new_min_gpl"><img src="https://img.shields.io/badge/pub-2.5.0-blue?logo=dart" alt="pub version"></a>
...
```yaml
dependencies:
  ffmpeg_kit_flutter_new_min_gpl: ^2.5.0
```
