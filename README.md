...
<p align="center">
  <a href="https://pub.dev/packages/ffmpeg_kit_flutter_new_min"><img src="https://img.shields.io/badge/pub-3.5.5-blue?logo=dart" alt="pub version"></a>
...
```yaml
dependencies:
  ffmpeg_kit_flutter_new_min: ^3.6.0
```
